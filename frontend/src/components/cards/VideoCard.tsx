  ...
  return (
    <Card className="group overflow-hidden transition-colors hover:border-brand">
      <div className="relative">
        <ImageWithFallback src={item.thumbnail} alt={item.title} fallbackLabel="Видео" className="aspect-video" />
      ...
      <div className="flex min-h-48 flex-col p-5">
        ...
        {item.description ? <p className="mt-3 line-clamp-2 text-sm leading-6 text-ink-soft">{item.description}</p> : null}

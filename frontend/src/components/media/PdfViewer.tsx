    ...
    <div className="rounded-lg border border-border bg-white">
      <div className="flex flex-col gap-3 border-b border-border p-4 sm:flex-row sm:items-center sm:justify-between">
        ...
        <div className="flex flex-wrap gap-2">
          <ButtonLink to={url} target="_blank" rel="noopener noreferrer" variant="secondary" icon={<ExternalLink aria-hidden className="h-4 w-4" />}>
            Ачуу
          </ButtonLink>
          <ButtonLink to={url} target="_blank" rel="noopener noreferrer" icon={<Download aria-hidden className="h-4 w-4" />}>
            PDF жүктөө
          </ButtonLink>
        </div>
      </div>
      <object
        ...
        className="hidden h-[760px] w-full md:block"
        data={url}
